          ...
          <div className="panel-body">
            ...
            <ul className="list-group">
              ...
              <li className="list-group-item">
                ...
                In the dropdown list choose Custom RPC option. Then enter <a href="https://tosscoin.net">https://tosscoin.net</a> URL in the field New RPC and press Save. That’s it!<br />
